    ...
    >
      ...
      >
        <div className="flex ml-4 items-center gap-1 mt-2">
          <FaUserCircle className="w-12 h-12 text-rose-600" />
          <div>
            <h1 className="pl-4 pr-4 mt-2 text-lg text-black font-bold">
              {user?.name}
            </h1>
            <h1 className="pl-4 pr-4 text-md text-rose-600 font-bold">
              {user?.username}
            </h1>
          </div>
        </div>
          ...
          <ul className="space-y-4 text-gray-600 mt-2">
            {user?.isVerified ? (
              <li className="border-b pl-6 pr-6 border-gray-300 pb-2 flex items-center space-x-3">
                ...
                <a
                  href={'/features/bids'}
                  className="text-[16px] font-semibold hover:text-rose-600"
                >
                  My Bids
                </a>
              </li>
            ...
            <div className="text-center bg-rose-50 p-2 items-center justify-items-center">
              <li
                onClick={handleLogout}
                className=" border-gray-300 text-center justify-center flex items-center space-x-3 cursor-pointer"
              >
                <FaSignOutAlt className="text-rose-500 h-6 w-6" />
                <a
                  href="#"
                  className="text-[16px] font-semibold hover:text-rose-600"
                >
