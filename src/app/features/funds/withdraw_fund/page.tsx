        ...
        <Card>
          ...
          <div className="flex flex-col items-center mt-4">
            <button
              ...
              className="bg-rose-500 uppercase text-white font-medium py-2 px-4 rounded shadow-md hover:bg-rose-600 disabled:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:ring-opacity-50"
            >
              Withdraw Cash
            </button>
          </div>
          {modalVisible && bankDetails && (
            <Modal onClose={() => setModalVisible(false)}>
              <div className="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto">
                <h2 className="text-xl font-semibold text-center text-rose-600 p-2">
                ...
                <ul className="mt-4 space-y-2">
                  {withdrawalMethods.map((method) => (
                    <li key={method.value}>
                      <label className="flex items-center p-2 bg-rose-100 rounded-md hover:bg-rose-200 transition">
                        <input
                          type="radio"
                ...
                <div className="modal-actions mt-4">
                  <button
                    ...
                    className="w-full bg-rose-500 text-white font-medium py-2 rounded hover:bg-rose-600 transition focus:outline-none focus:ring-2 focus:ring-rose-400 focus:ring-opacity-50"
                  >
                    Confirm Withdrawal
                  </button>
                </div>
          ...
          <div className="flex justify-center items-center text-center mt-4">
            {!bankDetails && (
              <button
                ...
                className="border border-rose-600 text-rose-600 p-2 rounded-md hover:bg-rose-50 transition duration-300"
              >
                Add Bank Details
              </button>
            )}
